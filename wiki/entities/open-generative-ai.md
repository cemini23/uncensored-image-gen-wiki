...
Cross-wiki stub routed from `@osint-wiki/entities/tools/open-generative-ai.md` during ingest.
What prompted this page + which sources synthesize into it — fill in on next
ingest pass.

## Narrative

Cross-platform desktop app with 200+ models, C++ inference engines (sd.cpp, Wan2GP), and dual-mode Image/Cinema Studio. MIT license, v1.0.11, 13.6k stars. Steal-from tier per K45 v3 multi-wiki tool eval — extract sd.cpp C++ inference parameters and Generative-Media-Skills API logic; do NOT adopt React/Electron desktop client.
